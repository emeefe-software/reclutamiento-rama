                ...
                <div class="col-md-6 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>
                                Configura la dirección IP pública de las instalaciones para el acceso desde la app móvil.
                            </p>
                            <textarea required class="form-control w-100" name="ip" cols="30" rows="1">{{\Setting::get('ip')}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <textarea required class="form-control w-100" name="faceToFace" cols="30" rows="8">{{\Setting::get('msgFaceToFace')}}</textarea>
                        </div>
                    </div>
                    <br>
                    <div class="card">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <textarea required class="form-control w-100" name="videoCall" cols="30" rows="8">{{\Setting::get('msgVideoCall')}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
