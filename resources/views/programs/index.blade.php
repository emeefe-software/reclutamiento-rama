...
@section('description')
    ...
    <p>
        ...
        <br><br>Adicionálmente puedes pausar/reanudar un programa en el listado cambiando el valor del checkbox y presionando el botón <b>Actualizar</b>, los programas pausados no aparecerán como opciones disponibles a los aspirantes al querer agendar entrevista.
